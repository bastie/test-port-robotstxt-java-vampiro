...
namespace com.google.search.robotstxt
{
    ...
    */
    bool allowedByRobots(java.util.List<String> userAgents, String url);
    ...
    * @return {@code true} iff verdict is ALLOWED
    */
    bool singleAgentAllowedByRobots(String userAgent, String url);
    ...
    * @return {@code true} iff verdict is ALLOWED
    */
    bool ignoreGlobalAllowedByRobots(java.util.List<String> userAgents, String url);
    }
}